...
bash -c 'source "$1"; declare -F main preflight read_live_configuration select_knowledge_seed fixture_revision ensure_knowledge_fixture_and_database run_live_scenario validate_junit write_manifest >/dev/null' bash "${ROOT}/knowledge-uat.sh"
